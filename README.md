...
`v1.1.14` refreshes the social proof stats:

- Updates Facebook followers to `4M`.
- Updates total followers to `12.4M`.

`v1.1.13` refreshes the social proof stats:

- Updates Facebook followers to `3.9M`.
- Updates total followers to `12.3M`.

`v1.1.12` refreshes the social proof stats:

- Updates Facebook followers to `3.8M`.
- Updates total followers to `12.2M`.

`v1.1.11` refreshes the social proof stats:

- Updates Facebook followers to `3.7M`.
